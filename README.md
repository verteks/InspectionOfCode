...
37 | ненужный цикл | цикл делает только одну итерацию (если делает), потому что выход из цикла осуществляется либо break либо return, здесь подойдет простой if
